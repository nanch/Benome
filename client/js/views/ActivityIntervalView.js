...
var ActivityIntervalView = Backbone.View.extend({
    tagName: 'div',
    className: 'activity-interval-view',
    ...
    initialize: function(options) {
        ...
        this.nonDeletable = options.nonDeletable || false;
    ...
    render: function() {
        ...
        if (this.G.isMobile) {
            this.$el.addClass('activity-interval-view-mobile');
        }
...
module.exports = ActivityIntervalView;